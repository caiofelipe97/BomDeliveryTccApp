...
export default class DemandsScreen extends Component {
  ...
  return {
    ...
    componentDidMount() {
      let olderDemands = [
        ...
        'adress': 'Rua Agamenon Magalhaes, 230 - Centro, Alagoa Nova - Paraiba, CEP: 58400-137',
        paymentMethod:'',
        values:{
          'subtotal': 24.50,
          'delivery': 6,
      ...
      },
      {
        ...
        'adress': "Rua Luiza Bezerra Motta, 720 - Centro, Alagoa Nova - Paraiba, CEP: 58410-410, Referencia: Em frente ao antigo sitio sao joao",
        paymentMethod:'',
        values:{
          'subtotal': 22,
          'delivery': 0,
  ...
  renderOlderDemandsCards(demands) {
      ...
      return demands.map((demand, index
        ...
        <DemandCard  key={index} demand={demand} navigation={this.props.navigation}/>
      )
  }
  ...
  render() {
    ...
    return (
      <Container >
      <Tabs tabBarUnderlineStyle={{ backgroundColor: '#FFFF00' }} renderTabBar={()=> <ScrollableTab style={{borderWidth: 0, backgroundColor:'#800080',height:40 }}  />}>
          ...
          <Content>
            {this.renderOlderDemandsCards(olderDemands)}
          </Content>
          </Tab>
