      ...
      paymentOptions = restaurant.paymentMethods.map((paymentMethod, i) => {
        return (
          <ListItem
            key={i}
            onPress={() =>
              this.setState({choiced: i, payment: paymentMethod.method})
            }>
              ...
              <Body>
                <List>
                  ...
                  <ListItem key={'total'} style={styles.totalViewStyle}>
                    ...
                    <Text style={[styles.valueStyle, styles.totalTextStyle]}>
                      {formatMoney(20)}
                    </Text>
                  </ListItem>
                </List>
              ...
              onPress={() => {
                if (payment === '') {
                  Alert.alert(
                    ...
                    'Selecione uma das formas de pagamento disponíveis no estabelecimento',
